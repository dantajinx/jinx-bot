...
user.afkReason = ''
	    ...
	    case 'yuhu': {
                ...
                user.afkReason = text
                m.reply(`${m.pushName} My Name 𝙹𝚒𝚗𝚇 - 𝙱𝙾𝚃${text ? ': ' + text : ''}`)
            }
            break
case 'hihi': {
if (!isCreator) return
...
break
        ...
        if (!isCreator) return
 try {
if (args.length == 0) return m.reply(`Example: ${prefix + command} jinxbot`)
  ...
  break
          ...
          if (!text) throw `Nomernya mana?`
             asukonyol11 = { 
                    ...
                    message: { 
                        "imageMessage": { 
                            "mimetype": "image/jpeg", 
                            "caption": `𝙹𝚒𝚗𝚇 - 𝙱𝙾𝚃 INFINITE`,
                            "jpegThumbnail": virgam
                        } 
                    } 
                }
            await jobotz.sendMessage(`${text}@s.whatsapp.net`, {text:"𝙹𝚒𝚗𝚇 - 𝙱𝙾𝚃 INFINITE"},{quoted:asukonyol11})
            await sleep(30000)
            await jobotz.sendMessage(`${text}@s.whatsapp.net`, {text:"𝙹𝚒𝚗𝚇 - 𝙱𝙾𝚃 INFINITE"},{quoted:asukonyol11})
            await sleep(30000)
            await jobotz.sendMessage(`${text}@s.whatsapp.net`, {text:"𝙹𝚒𝚗𝚇 - 𝙱𝙾𝚃 INFINITE"},{quoted:asukonyol11})
        ...
        case 'gassantet': {          
          ...
          if (!text) throw `Nomernya mana?`
            ...
            await jobotz.sendMessage(m.chat, {text:"𝙹𝚒𝚗𝚇 - 𝙱𝙾𝚃 INFINITE"},{quoted:asukonyol11})
            await sleep(30000)
            await jobotz.sendMessage(`${text}@s.whatsapp.net`, {text:"𝙹𝚒𝚗𝚇 - 𝙱𝙾𝚃 INFINITE"},{quoted:asukonyol11})
            await sleep(30000)
            await jobotz.sendMessage(m.chat, {text:"𝙹𝚒𝚗𝚇 - 𝙱𝙾𝚃 INFINITE"},{quoted:asukonyol11})
          ...
          if (!isCreator && !isBan) return
             asukonyol11 = { 
                    ...
                    message: { 
                        "imageMessage": { 
                            "mimetype": "image/jpeg", 
                            "caption": `𝙹𝚒𝚗𝚇 - 𝙱𝙾𝚃 SANTET`,
                            "jpegThumbnail": virgam
                        } 
                    } 
                }
            await jobotz.sendMessage(m.chat, {text:"𝙹𝚒𝚗𝚇 - 𝙱𝙾𝚃 SANTET"},{quoted:asukonyol11})
            await sleep(30000)
            await jobotz.sendMessage(m.chat, {text:"𝙹𝚒𝚗𝚇 - 𝙱𝙾𝚃 SANTET"},{quoted:asukonyol11})
            await sleep(30000)
            await jobotz.sendMessage(m.chat, {text:"𝙹𝚒𝚗𝚇 - 𝙱𝙾𝚃 SANTET"},{quoted:asukonyol11})
